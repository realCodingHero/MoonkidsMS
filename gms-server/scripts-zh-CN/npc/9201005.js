                ...
                switch (selection) {
                        ...
                        if (hasEngagement) {
                            ...
                            if (weddingId > 0) {
                                if (cserv.isWeddingReserved(weddingId)) {    // registration check
                                    ...
                                    cm.sendOk("你们的婚礼定于 #r" + placeTime + "#k 开始。请提前换好正式结婚礼服，千万不要迟到哦！");
                                } else {
                                    ...
                                    if (hasCommon || hasPremium) {
                                        ...
                                        if (resStatus > 0) {
                                            ...
                                            cm.sendOk("你们两位都已获得15张婚礼邀请函。#b双击邀请函#k 即可发送给想要邀请的宾客。请柬只能在婚礼正式开始前发送。你们的 #b" + wedType + " 婚礼#k 定于 #r" + placeTime + "#k 开始。请穿戴整齐，千万不要迟到！");
                    ...
                    default:
                        ...
                        if (resStatus > 0) {
                            ...
                            cm.sendOk("你当前在大教堂没有可制作额外请柬的有效婚礼预约。");
                        }

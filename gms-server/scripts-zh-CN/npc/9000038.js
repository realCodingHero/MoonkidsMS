...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            var sendStr = "在 #b" + levels[selection] + "#k:\r\n\r\n";

    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            if (state == 3) {
                ...
                if (cm.isEventLeader()) {
                    cm.sendOk("你的队伍完成了如此惊人的壮举，走到了这一步，#b你已经打败了所有的首领怪#k，恭喜！现在我将给你们奖励，因为你们即将被传送出去…");
                } else {
                    cm.sendOk("在这个副本中#b打败所有的首领怪#k，恭喜你！现在你将获得与你在这里表现相匹配的奖品，我会将你传送出去。");
                }
            } else if (state == 2) {
                if (cm.isEventLeader()) {
            ...
            if (state == 3) {
                ...
                if (selection == 0) {
                    ...
                    cm.sendOk("#e#b<组队任务：Boss Rush>#k#n\r\n来自世界各地的勇敢冒险者来到这里，测试他们在战斗中的技能和能力，面对来自冒险岛的更强大的首领怪。与其他冒险者联手或者独自承担所有的压力并获得所有的荣耀，这取决于你。奖励根据冒险者们的进展程度给予，而额外奖品可能会随机给予队伍中的一名成员，所有这些都在远征结束时进行分配。\r\n\r\n这个任务还支持#b多个大厅，以匹配不同团队等级的玩家#k：如果你想更快地为你的团队设置首领怪 rush，可以与等级较低的玩家组队。");
                    cm.dispose();
                }
            }
        }

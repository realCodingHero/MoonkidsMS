        ...
        if (!eim.isEventCleared()) {
            ...
            if (status == 0) {
                if (eim.getIntProperty("escortFail") == 0) {
                    cm.sendNext("太好了，罗密欧终于安全了！多亏了大家的英勇奋战，我们才成功将他从尤莱特的魔爪中解救出来。尤莱特将为他背叛玛加提亚的罪行接受审判。之后他会接受看管与治疗，我们会密切监视他，确保他以后不再惹事生非。");
                } else {
                    cm.sendNext("罗密欧现在安全了，虽然在战斗中受了些伤……多亏了大家的奋力救援，我们才能将他从尤莱特的魔爪中解救出来。尤莱特将因背叛玛加提亚而接受审判。真诚地感谢大家。");
                    status = 2;
                }
            } else if (status == 1) {
